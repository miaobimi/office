		...
		<div class="content-body">
			...
			<div class="content">
				<div class="content-in">
					<div class="x-search-panel"><form onsubmit="return false;" method="post" name="search" class="x-form"><fieldset><input type="hidden" value="histTrades" name="cmd"><input type="hidden" value="finance" name="menu"><div class="column"><dl><dt>交易日期：</dt><dd><input type="text" placeholder="从" class="w30 hasDatepicker" value="" name="closeStartDate" vtype="date" id="dp1448674094667"><span class="space">-</span><input type="text" placeholder="到" class="w30 hasDatepicker" value="" name="closeEndDate" vtype="date" id="dp1448674094668"></dd></dl></div><div class="column"><dl><dt>金额范围：</dt><dd><input type="text" placeholder="大于等于" class="w30" value="" name="startNumber" vtype="number"><span class="space">-</span><input type="text" placeholder="小余等于" class="w30" value="" name="endNumber" vtype="number"></dd></dl></div><div class="column"><div class="x-submit-panel"><button class="btn btn-success" type="submit">搜 索</button></div></div></fieldset></form></div><!--data-option-->
