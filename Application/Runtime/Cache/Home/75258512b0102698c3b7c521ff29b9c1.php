		...
		<div class="content-body">
			...
			<div class="content">
					...
					<table class="table table-striped table-condensed ">
					   <tbody>
					      ...
					      <tr>
					         ...
					         <td>
					         余额：<span style="color: #3aae01" id="balance">$8,286.44</span><span class="y"></span> 净值：<span style="color: #ff5d5b" id="equity">$8,286.44</span><span class="y"></span>保证金：<span style="color: #ff5d5b" id="margin">$0.00</span><span class="y"></span>可用保证金：<span style="color: #3aae01" id="margin_free">$8,286.44</span>
					         </td>
					      </tr>
					      <tr>
				...
				<div class="x-color-panel x-balance-panel">
					<label>资产</label>
					<div>
						<span>余额</span><strong id="memberBalance">$8,286.44</strong>
					</div>
					<div>
						<span>净值</span><strong id="memberEquity">$8,286.44</strong>
					</div>
					<div>
						<span>保证金</span><strong id="memberMargin">$0.00</strong>
					</div>
					<div>
						<span>可用保证金</span><strong id="memberMarginfree">$8,286.44</strong>
					</div>
				</div>
